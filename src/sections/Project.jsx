      ...
      <div className="relative overflow-hidden min-h-screen">
        ...
        <div className="gallery flex max-md:flex-col min-h-screen relative z-10">
          ...
          <div className="rightblock w-2/3 max-md:w-full flex flex-col justify-center ml-auto">
            ...
            <a href="https://kanbanflowx.vercel.app/login" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">Kanban board <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Full-Stack Web App</span></h2>
            ...
            <a href="https://nike-adidas.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold max-md:mb-3">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">Nike x Adidas <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">E-Commerce Concept • WIP</span></h2>
            ...
            <a href="https://midnightmagic.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold max-md:mb-3">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">Event Management <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Freelance Demo Work</span></h2>
            ...
            <a href="https://bmw-m.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  <img className="w-full" draggable="false" src={bmwm} alt="Bmw M Project" />
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">BMW M  <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Landing Page</span></h2>
            ...
            <a href="https://zenitsu-parallax.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold max-md:mb-3">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">Parallax <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Parallax Effect</span></h2>
            ...
            <a href="https://ronaldo7site.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">GSAP <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Interactive Website</span></h2>
            ...
            <a href="https://apple-clone-webdesign.netlify.app/" target="_blank" rel="noopener noreferrer">
              <div className="details h-screen max-md:h-full max-md:py-10 text-white text-3xl font-bold">
                <div className="box w-3/4 max-md:w-full max-md:px-2">
                  ...
                  <h2 className="text-2xl font-rmneue mt-3 font-thin flex items-center justify-between">Apple website clone <span className="font-pptelegraf text-[12px] text-[#6A6A6A]">Landing Page</span></h2>
